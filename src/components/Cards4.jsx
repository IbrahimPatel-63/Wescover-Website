...
function Cards4({name,title,price,image,image2}) {
  return (
    <div>
        <div className='h-[46vw] w-[46vw] md:h-[20vw] md:w-[19vw] lg:h-[20vw] lg:w-[20vw]  xl:h-[18vw] xl:w-[18vw] 2xl:h-[19vw] 2xl:w-[19vw] bg-purple-400'><img src={image} alt="" className='h-full w-full object-cover' loading='lazy' /></div>
